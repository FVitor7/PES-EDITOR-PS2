...
public class PSDConnPanel extends JDialog
{
	...
	final String domain = "https://pes-editor.herokuapp.com/";
	...
	void setupGUI()
	{
		...
		sp1.setBounds(10, 120, 260,300);
		sp1.getViewport().setBackground(Color.WHITE);
		sp1.getViewport().add(statData);
		
		sp2.setBounds(290, 120, 300,300);
		sp2.getViewport().setBackground(Color.WHITE);
		sp2.getViewport().add(playerList);
